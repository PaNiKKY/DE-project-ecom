...
def customer_clean_df(customer):
...
def geolocation_clean_df(geolocation):
...
def order_items_clean_df(order_items):
...
def product_clean_df(product):
    product_df = pd.read_csv(f"/opt/airflow/data/{product}.csv")
    product_df["product_id"] = product_df["product_id"].astype(str)
    product_df["product_name_lenght"] = product_df["product_name_lenght"].astype(int)
    product_df["product_description_lenght"] = product_df["product_description_lenght"].astype(int)
    product_df["product_photos_qty"] = product_df["product_photos_qty"].astype(int)
